										...
										<div class="message-box" style="width: 1100px;">
											...
											<div class="message-text-container">
												...
												<input type="text" class="form-control" id="msgTitle"
												       ...
												       pattern=".{2,30}" style="width:800px" value="${ message.msgTitle }">
												</div>
												<div>
												...
												<label>받는 사람</label>
												<div class="selectBox">
												<select id="recvSelbox" name="recvNic">
												  <option selected>즐겨찾기 목록</option>
												  <c:forEach var="bookmarks" items="${ bookmarks }">
												  <option value="${ bookmarks.bookmarkNic }">${ bookmarks.bookmarkNic }</option>
												  </c:forEach>
												  <option value="direct">직접입력</option>
												</select>
												</div>
												<input type="text" class="form-control"
													   placeholder="받는 사람 닉네임" id="recvSelboxDirect" name="recvSelboxDirect" style="width:170px">
												</div>
												<br>
												<div>
												...
												<label>내용</label>
												<br>
												<textarea name="msgContent" placeholder="내용 입력" required="required" style="border: 2px solid lightgray;border-radius: 4px;">${ message.msgContent }</textarea>
												<button type="submit">
...
<jsp:include page="/WEB-INF/views/module/footer.jsp" />
	...
	<div class="side-panel">
		...
		$(function() {
			...
			$("#recvSelboxDirect").hide();
			
			$("#recvSelbox").change(function() {
				$("#recvSelboxDirect").val('');
				// 직접입력을 누를 때 나타남
				if ($("#recvSelbox").val() == "direct") {
					$("#recvSelboxDirect").show();
				} else {
					$("#recvSelboxDirect").hide();
				}
