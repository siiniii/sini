							...
							<div class="row" id="page-contents">
								...
								<div class="col-lg-6">
									<div class="central-meta" style="width: 1200px">
										<div class="messages">
											<%-- 즐겨찾기 등록기능 구현용 --%>
											<form id="bookmark-settings-form" action="sAddBookmark" method="post">
												<input type="hidden" name="bookmarkNic">
												<input type="hidden" name="pageNo" value="${ pageNo }">
											</form>
											<%-- 즐겨찾기 해제기능 구현용 --%>
											<form id="remove-bookmark-settings-form" action="sRemoveBookmark" method="post">
												<input type="hidden" name="bookmarkNic">
												<input type="hidden" name="pageNo" value="${ pageNo }">
											</form>
											<form>
												<h5 class="f-title">
													<i class="ti-bell"> Sended Message</i>
												</h5>
												<div class="message-box">
													...
													<table id="recv-list-table" class="table" style="text-align: center">
														...
														<td>
														<a href='sendedMessageDetail.action?msgNo=${ message.msgNo }'>
														${ message.msgTitle }
														</a>
														</td>
														<td>
