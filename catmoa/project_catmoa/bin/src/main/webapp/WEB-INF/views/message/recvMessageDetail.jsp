						...
						<div class="row" id="page-contents">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="messages">
										<h5 class="f-title"><i class="ti-bell"> Recieved Message Detail</i></h5>
										<div class="table-responsive" style="text-align:center;">
										<form action=goReplyMessage method="post">
										<table id="datatable-scroller"
											...
											<tbody>
												<tr>
													...
													<td>
													<input type="hidden" name="title" value="${ message.msgTitle }">
													${ message.msgTitle }
													</td>
												</tr>
												<tr>
													<th class="active" >보낸 사람</th>
													<td>
													<input type="hidden" name="recvNic" value="${ message.sendNic }">
													${ message.sendNic }
													</td>
												</tr>
												<tr>
...
${ fn:replace(message.msgContent, enter, "<br>") }
										...
										<button type="submit" class="btn btn-light" style="align:center">Reply</button>
										</form>
										</div>
