package com.project_catmoa.view;
...
public class MessageDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model,
		...
		MessageAttachDto attachment = (MessageAttachDto)model.get("attachment");
		...
		String path = application.getRealPath("/resources/msg-attachments/" + attachment.getSavedFileName());
